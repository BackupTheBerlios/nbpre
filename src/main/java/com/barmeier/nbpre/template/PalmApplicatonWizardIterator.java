...
public class PalmApplicatonWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {

    private int index;
    private WizardDescriptor.Panel[] panels;
    private WizardDescriptor wiz;

    public PalmApplicatonWizardIterator() {
    }

    public static PalmApplicatonWizardIterator createIterator() {
        return new PalmApplicatonWizardIterator();
    }
