 ...
 * @author barmeier
 */
public class MojoCodeCompletionProvider implements CompletionProvider {

    Properties props;

    public MojoCodeCompletionProvider() {
        super ();
        props = new Properties();
        try {
            props.load(this.getClass().getResourceAsStream("Completion.properties"));
        }
        catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public CompletionTask createTask(int type, JTextComponent arg1) {
        ...
        return new AsyncCompletionTask(new AsyncCompletionQuery() {
            ...
            protected void query(CompletionResultSet completionResultSet, Document document, int caretOffset) {
                ...
                for (Object name:props.keySet()) {
                    ...
                    if (!((String)name).equals("") && ((String)name).startsWith(filter)) {
                        ...
                        completionResultSet.addItem(
                                new MojoCompletionItem(((String)name), props.getProperty((String)name),
